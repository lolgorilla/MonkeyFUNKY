...
"I", "we", "us", "our" and "Monkey Funky": The developer(s).
"services", "game": Games/services developed and published by Flixzy Studios

2. DATA COLLECTION

A. Hardware ID
Your hardware ID gets collected by PlayFab to log into your PlayFab/Monkey Funky account.

B. IP Address
Your IP address gets stored on your PlayFab/Monkey Funky account.

C. Removal of PlayFab/Bird Runners account
...
A: IP Address
As stated in Section 2A, your IP address gets stored on your PlayFab/Monkey Funky account and is only be used for IP bans and other moderation purposes.
